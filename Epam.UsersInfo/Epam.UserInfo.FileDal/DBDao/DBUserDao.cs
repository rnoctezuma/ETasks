...
namespace Epam.UserInfo.Dal.DBDao
{
    public class DBUserDao : IUserDao
    {
        ...
        public IEnumerable<User> GetAll()
        {
            ...
            {
                SqlCommand cmd = connection.CreateCommand();
                cmd.CommandText = " SELECT ID, Name, Surname, Patronymic, DateOfBirth, ImageID FROM db.[User]";
                connection.Open();
                ...
                while (reader.Read())
                {
                    ...
                    yield return new User { Name = name, DateOfBirth = dateOfBirth, Id = Id, Photo = new Photo(imageID) };
                }
            }
        }
